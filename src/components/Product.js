...
const Product = () => {
    ...
    useEffect(() => {
        ...
        setDetails(locatoin.state.item)
    ...
    return (
        <div>
            ...
            <div className="max-w-screen-xl mx-auto my-10 max-md:flex-col max-md:justify-center max-md:items-center  flex gap-10">

                <div className=  "  max-md:w-full max-md:px-4  pl-5 w-2/5 relative">
                    <img
                        src={details.image}
                    ...
                    <div className='absolute top-4 right-0'>
                        {
                            details.isNew &&
                            (<p className='bg-black text-white font-semibold font-titleFont px-10 py-1'>
                                Sale
                            </p>)
                        }
                    </div>
                ...
                <div className="w-3/4  flex flex-col justify-center gap-12">
                    ...
                    <p className="text-base to-gray-500 -mt-3"> {details.description}</p>
